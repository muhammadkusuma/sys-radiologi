...
class AssessmentController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'contrast_dose_ml' => 'nullable|numeric',
            ...
            'post_pulse' => 'nullable|integer',
            'post_temperature' => 'nullable|numeric',
            'post_respiratory_rate' => 'nullable|integer',
            'post_oxygen_saturation' => 'nullable|numeric',
