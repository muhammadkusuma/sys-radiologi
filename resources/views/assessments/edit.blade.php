    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        <div class="mb-6 flex justify-between items-center no-print">
            <div>
                <a href="{{ route('dashboard') }}"
                    class="text-xs font-semibold text-slate-500 hover:text-slate-900 transition flex items-center mb-1">
            ...
            <div class="bg-blue-50 border border-blue-100 rounded-xl px-4 py-2 text-right">
                ...
                <span class="text-sm font-bold text-blue-900">{{ $patient->name }} (RM:
                    {{ $patient->medical_record_number }})</span>
            </div>
        </div>
        ...
        <form action="{{ route('assessments.update', $assessment->id) }}" method="POST" id="assessmentForm">
                ...
                <div class="paper-container">
                            ...
                            <td>
                                <div class="flex items-center space-x-2">
                                    <input type="date" name="procedure_date"
                                        value="{{ old('procedure_date', $assessment->procedure_date ? $assessment->procedure_date->format('Y-m-d') : '') }}"
                                        class="paper-input w-32">
                                    <span>Jam:</span>
                                    <input type="text" data-clocklet="format: HH:mm" name="procedure_time"
                                        value="{{ old('procedure_time', $assessment->procedure_time ? substr($assessment->procedure_time, 0, 5) : '') }}"
                                        class="paper-input w-20 text-center">
                                    <span>WIB</span>
                                </div>
                            </td>
                        </tr>
                            ...
                            <td>
                                <select name="referring_doctor_id" id="referring_doctor_id" class="paper-input">
                                    ...
                                    @foreach ($doctors as $doc)
                                        <option value="{{ $doc->id }}"
                                            {{ old('referring_doctor_id', $assessment->referring_doctor_id) == $doc->id ? 'selected' : '' }}>
                                            {{ $doc->name }}</option>
                                    @endforeach
                                </select>
                            </td>
                            ...
                            <td>
                                <select name="radiology_nurse_id" id="radiology_nurse_id" class="paper-input">
                                    ...
                                    @foreach ($nurses as $ns)
                                        <option value="{{ $ns->id }}"
                                            {{ old('radiology_nurse_id', $assessment->radiology_nurse_id) == $ns->id ? 'selected' : '' }}>
                                            {{ $ns->name }}</option>
                                    @endforeach
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="diagnosis"
                                    value="{{ old('diagnosis', $assessment->diagnosis) }}"
                                    placeholder="Tulis diagnosis klinis..." class="paper-input">
                            </td>
                            <td class="label-cell">Jenis Pemeriksaan</td>
                            <td>
                                <input type="text" name="examination_type"
                                    value="{{ old('examination_type', $assessment->examination_type) }}"
                                    placeholder="cth: CT Scan Kepala Kontras" class="paper-input">
                            </td>
                        </tr>
                    </table>
                    ...
                    <table class="paper-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="general_condition" rows="2" class="paper-input resize-y py-1"
                                    placeholder="Keadaan umum... (bisa enter/multiline)">{{ old('general_condition', $assessment->general_condition) }}</textarea>
                            </td>
                            <td class="label-cell">Keluhan</td>
                            <td>
                                <textarea name="during_complaint" rows="2" class="paper-input resize-y py-1"
                                    placeholder="Keluhan saat tindakan...">{{ old('during_complaint', $assessment->during_complaint) }}</textarea>
                            </td>
                            <td class="label-cell">Keluhan</td>
                            <td>
                                <textarea name="post_procedure_complaint" rows="2" class="paper-input resize-y py-1"
                                    placeholder="Keluhan setelah tindakan...">{{ old('post_procedure_complaint', $assessment->post_procedure_complaint) }}</textarea>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="consciousness_level" rows="2" class="paper-input resize-y py-1"
                                    placeholder="Tingkat kesadaran...">{{ old('consciousness_level', $assessment->consciousness_level) }}</textarea>
                            </td>
                            <td class="label-cell">Tanda-tanda Alergi</td>
                            <td>
                                <textarea name="allergy_sign_during" rows="2" class="paper-input resize-y py-1"
                                    placeholder="Tanda alergi saat tindakan...">{{ old('allergy_sign_during', $assessment->allergy_sign_during) }}</textarea>
                            </td>
                            <td class="label-cell">Tanda-tanda Alergi</td>
                            <td>
                                <textarea name="allergy_sign_after" rows="2" class="paper-input resize-y py-1"
                                    placeholder="Tanda alergi setelah tindakan...">{{ old('allergy_sign_after', $assessment->allergy_sign_after) }}</textarea>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center space-x-1">
                                    <input type="number" step="0.01" name="egfr" min="0" max="300"
                                        value="{{ old('egfr', $assessment->egfr) }}" class="paper-input w-20 text-right">
                            ...
                            <td>
                                <label class="mr-2"><input type="radio" name="itching_during" value="0"
                                        {{ old('itching_during', $assessment->itching_during ? '1' : '0') == '0' ? 'checked' : '' }}>
                                    Tidak</label>
                                <label><input type="radio" name="itching_during" value="1"
                                        {{ old('itching_during', $assessment->itching_during ? '1' : '0') == '1' ? 'checked' : '' }}>
                                    Ya</label>
                            </td>
                            <td class="label-cell">Gatal-gatal</td>
                            <td>
                                <label class="mr-2"><input type="radio" name="itching_after" value="0"
                                        {{ old('itching_after', $assessment->itching_after ? '1' : '0') == '0' ? 'checked' : '' }}>
                                    Tidak</label>
                                <label><input type="radio" name="itching_after" value="1"
                                        {{ old('itching_after', $assessment->itching_after ? '1' : '0') == '1' ? 'checked' : '' }}>
                                    Ya</label>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center space-x-1">
                                    ...
                                    <input type="text" data-clocklet="format: HH:mm" name="last_meal_time"
                                        value="{{ old('last_meal_time', $assessment->last_meal_time ? substr($assessment->last_meal_time, 0, 5) : '') }}"
                                        class="paper-input w-20 text-center">
                                </div>
                            </td>
                            ...
                            <td>
                                <label class="mr-2"><input type="radio" name="nausea_during" value="0"
                                        {{ old('nausea_during', $assessment->nausea_during ? '1' : '0') == '0' ? 'checked' : '' }}>
                                    Tidak</label>
                                <label><input type="radio" name="nausea_during" value="1"
                                        {{ old('nausea_during', $assessment->nausea_during ? '1' : '0') == '1' ? 'checked' : '' }}>
                                    Ya</label>
                            </td>
                            <td class="label-cell">Mual</td>
                            <td>
                                <label class="mr-2"><input type="radio" name="nausea_after" value="0"
                                        {{ old('nausea_after', $assessment->nausea_after ? '1' : '0') == '0' ? 'checked' : '' }}>
                                    Tidak</label>
                                <label><input type="radio" name="nausea_after" value="1"
                                        {{ old('nausea_after', $assessment->nausea_after ? '1' : '0') == '1' ? 'checked' : '' }}>
                                    Ya</label>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center space-x-1">
                                    <input type="number" step="0.1" name="body_weight" min="1"
                                        max="500" value="{{ old('body_weight', $assessment->body_weight) }}"
                            ...
                            <td>
                                <label class="mr-2"><input type="radio" name="dizziness_during" value="0"
                                        {{ old('dizziness_during', $assessment->dizziness_during ? '1' : '0') == '0' ? 'checked' : '' }}>
                                    Tidak</label>
                                <label><input type="radio" name="dizziness_during" value="1"
                                        {{ old('dizziness_during', $assessment->dizziness_during ? '1' : '0') == '1' ? 'checked' : '' }}>
                                    Ya</label>
                            </td>
                            <td class="label-cell">Pusing</td>
                            <td>
                                <label class="mr-2"><input type="radio" name="dizziness_after" value="0"
                                        {{ old('dizziness_after', $assessment->dizziness_after ? '1' : '0') == '0' ? 'checked' : '' }}>
                                    Tidak</label>
                                <label><input type="radio" name="dizziness_after" value="1"
                                        {{ old('dizziness_after', $assessment->dizziness_after ? '1' : '0') == '1' ? 'checked' : '' }}>
                                    Ya</label>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center space-x-1">
                                    <input type="text" name="blood_pressure"
                                        value="{{ old('blood_pressure', $assessment->blood_pressure) }}"
                            ...
                            <td>
                                <label class="mr-2"><input type="radio" name="shortness_of_breath_during"
                                        value="0"
                                        {{ old('shortness_of_breath_during', $assessment->shortness_of_breath_during ? '1' : '0') == '0' ? 'checked' : '' }}>
                                    Tidak</label>
                                <label><input type="radio" name="shortness_of_breath_during" value="1"
                                        {{ old('shortness_of_breath_during', $assessment->shortness_of_breath_during ? '1' : '0') == '1' ? 'checked' : '' }}>
                                    Ya</label>
                            </td>
                            <td class="label-cell">Sesak Nafas</td>
                            <td>
                                <label class="mr-2"><input type="radio" name="shortness_of_breath_after"
                                        value="0"
                                        {{ old('shortness_of_breath_after', $assessment->shortness_of_breath_after ? '1' : '0') == '0' ? 'checked' : '' }}>
                                    Tidak</label>
                                <label><input type="radio" name="shortness_of_breath_after" value="1"
                                        {{ old('shortness_of_breath_after', $assessment->shortness_of_breath_after ? '1' : '0') == '1' ? 'checked' : '' }}>
                                    Ya</label>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center space-x-1">
                                    <input type="number" name="pulse" min="30" max="220"
                                        value="{{ old('pulse', $assessment->pulse) }}"
                                        class="paper-input w-20 text-right">
                                    <span>x/menit</span>
                                </div>
                            </td>
                            ...
                            <td>
                                <label class="mr-2"><input type="radio" name="swollen_eyes_after" value="0"
                                        {{ old('swollen_eyes_after', $assessment->swollen_eyes_after ? '1' : '0') == '0' ? 'checked' : '' }}>
                                    Tidak</label>
                                <label><input type="radio" name="swollen_eyes_after" value="1"
                                        {{ old('swollen_eyes_after', $assessment->swollen_eyes_after ? '1' : '0') == '1' ? 'checked' : '' }}>
                                    Ya</label>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center space-x-1">
                                    <input type="number" step="0.1" name="temperature" min="35"
                                        max="43" value="{{ old('temperature', $assessment->temperature) }}"
                                        class="paper-input w-20 text-right">
                                    <span>&deg;C</span>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="flex items-center space-x-1">
                                    ...
                                    <input type="text" data-clocklet="format: HH:mm" name="iv_insertion_time"
                                        value="{{ old('iv_insertion_time', $assessment->iv_insertion_time ? substr($assessment->iv_insertion_time, 0, 5) : '') }}"
                                        class="paper-input w-20 text-center">
                                    <span>WIB</span>
                                </div>
                            </td>
                            ...
                            <td>
                                <label class="mr-2"><input type="radio" name="bentol_after" value="0"
                                        {{ old('bentol_after', $assessment->bentol_after ? '1' : '0') == '0' ? 'checked' : '' }}>
                                    Tidak</label>
                                <label><input type="radio" name="bentol_after" value="1"
                                        {{ old('bentol_after', $assessment->bentol_after ? '1' : '0') == '1' ? 'checked' : '' }}>
                                    Ya</label>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="region" value="{{ old('region', $assessment->region) }}"
                                    placeholder="cth: Antecubiti Dextra" class="paper-input"></td>
                            <td class="label-cell">Tekanan Darah</td>
                            <td>
                                <div class="flex items-center space-x-1">
                                    <input type="text" name="post_blood_pressure"
                                        value="{{ old('post_blood_pressure', $assessment->post_blood_pressure) }}"
                                        placeholder="120/80" class="paper-input w-20 text-center">
                                    <span>mmHg</span>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center space-x-1">
                                    <input type="number" step="0.1" name="oxygen_saturation" min="50"
                                        max="100"
                            ...
                            <td><input type="text" name="iv_cath_size"
                                    value="{{ old('iv_cath_size', $assessment->iv_cath_size) }}" placeholder="cth: 20G"
                                    class="paper-input"></td>
                            <td class="label-cell">Nadi</td>
                            <td>
                                <div class="flex items-center space-x-1">
                                    <input type="number" name="post_pulse" min="30" max="220"
                                        value="{{ old('post_pulse', $assessment->post_pulse) }}"
                                        class="paper-input w-20 text-right">
                                    <span>x/menit</span>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center space-x-1">
                                    <input type="number" step="0.1" name="post_temperature" min="35"
                                        max="43"
                                        value="{{ old('post_temperature', $assessment->post_temperature) }}"
                                        class="paper-input w-20 text-right">
                                    <span>&deg;C</span>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center space-x-1">
                                    <input type="number" name="post_respiratory_rate" min="8" max="60"
                                        value="{{ old('post_respiratory_rate', $assessment->post_respiratory_rate) }}"
                                        class="paper-input w-20 text-right">
                                    <span>x/menit</span>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center space-x-2">
                                    <label><input type="radio" name="has_allergy_history" value="0"
                                            {{ old('has_allergy_history', $assessment->has_allergy_history ? '1' : '0') == '0' ? 'checked' : '' }}
                                            onchange="toggleAllergy(false)"> Tidak</label>
                                    <label><input type="radio" name="has_allergy_history" value="1"
                                            {{ old('has_allergy_history', $assessment->has_allergy_history ? '1' : '0') == '1' ? 'checked' : '' }}
                                            onchange="toggleAllergy(true)"> Ada:</label>
                                    <input type="text" name="allergy_description" id="allergy_desc_field"
                                        placeholder="..."
                                        value="{{ old('allergy_description', $assessment->allergy_description) }}"
                                        {{ old('has_allergy_history', $assessment->has_allergy_history ? '1' : '0') != '1' ? 'disabled' : '' }}
                            ...
                            <td>
                                <div class="flex items-center space-x-1">
                                    <input type="number" step="0.1" name="post_oxygen_saturation" min="50"
                                        max="100"
                                        value="{{ old('post_oxygen_saturation', $assessment->post_oxygen_saturation) }}"
                                        class="paper-input w-20 text-right">
                                    <span>%</span>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center space-x-1">
                                    <span>Batch:</span>
                                    <input type="text" name="contrast_batch"
                                        value="{{ old('contrast_batch', $assessment->contrast_batch) }}"
                                        class="paper-input w-24">
                                </div>
                            </td>
                            <td class="label-cell">Tanda-tanda Ekstravasasi</td>
                            <td>
                                <textarea name="extravasation_sign_during" rows="2" class="paper-input resize-y py-1"
                                    placeholder="cth: Tidak ada">{{ old('extravasation_sign_during', $assessment->extravasation_sign_during) }}</textarea>
                            </td>
                            <td class="label-cell"></td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="contrast_concentration"
                                    value="{{ old('contrast_concentration', $assessment->contrast_concentration) }}"
                                    class="paper-input"></td>
                            <td class="label-cell">Bengkak</td>
                            <td>
                                <label class="mr-2"><input type="radio" name="swelling_during" value="0"
                                        {{ old('swelling_during', $assessment->swelling_during ? '1' : '0') == '0' ? 'checked' : '' }}>
                                    Tidak</label>
                                <label><input type="radio" name="swelling_during" value="1"
                                        {{ old('swelling_during', $assessment->swelling_during ? '1' : '0') == '1' ? 'checked' : '' }}>
                                    Ya</label>
                            </td>
                            ...
                            <td>
                                <div class="flex items-center space-x-1">
                                    ...
                                    <input type="text" data-clocklet="format: HH:mm" name="iv_removal_time"
                                        value="{{ old('iv_removal_time', $assessment->iv_removal_time ? substr($assessment->iv_removal_time, 0, 5) : '') }}"
                                        class="paper-input w-20 text-center">
                                    <span>WIB</span>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center space-x-1">
                                    <input type="number" step="0.01" name="contrast_dose_ml" min="0"
                                        max="500"
                                        value="{{ old('contrast_dose_ml', $assessment->contrast_dose_ml) }}"
                                        class="paper-input w-20 text-right">
                                    <span>ml</span>
                                </div>
                            </td>
                            ...
                            <td>
                                <label class="mr-2"><input type="radio" name="pain_during" value="0"
                                        {{ old('pain_during', $assessment->pain_during ? '1' : '0') == '0' ? 'checked' : '' }}>
                                    Tidak</label>
                                <label><input type="radio" name="pain_during" value="1"
                                        {{ old('pain_during', $assessment->pain_during ? '1' : '0') == '1' ? 'checked' : '' }}>
                                    Ya</label>
                            </td>
                            <td class="label-cell">Tanda-tanda Ekstravasasi</td>
                            <td>
                                <textarea name="extravasation_sign_after" rows="2" class="paper-input resize-y py-1"
                                    placeholder="cth: Tidak ada">{{ old('extravasation_sign_after', $assessment->extravasation_sign_after) }}</textarea>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <label class="mr-2"><input type="radio" name="contrast_double_check" value="0"
                                        {{ old('contrast_double_check', $assessment->contrast_double_check ? '1' : '0') == '0' ? 'checked' : '' }}>
                                    Tidak</label>
                                <label><input type="radio" name="contrast_double_check" value="1"
                                        {{ old('contrast_double_check', $assessment->contrast_double_check ? '1' : '0') == '1' ? 'checked' : '' }}>
                                    Ya</label>
                            </td>
                            <td class="label-cell">Kemerahan</td>
                            <td>
                                <label class="mr-2"><input type="radio" name="redness_during" value="0"
                                        {{ old('redness_during', $assessment->redness_during ? '1' : '0') == '0' ? 'checked' : '' }}>
                                    Tidak</label>
                                <label><input type="radio" name="redness_during" value="1"
                                        {{ old('redness_during', $assessment->redness_during ? '1' : '0') == '1' ? 'checked' : '' }}>
                                    Ya</label>
                            </td>
                            <td class="label-cell">Bengkak</td>
                            <td>
                                <label class="mr-2"><input type="radio" name="swelling_after" value="0"
                                        {{ old('swelling_after', $assessment->swelling_after ? '1' : '0') == '0' ? 'checked' : '' }}>
                                    Tidak</label>
                                <label><input type="radio" name="swelling_after" value="1"
                                        {{ old('swelling_after', $assessment->swelling_after ? '1' : '0') == '1' ? 'checked' : '' }}>
                                    Ya</label>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <label class="mr-2"><input type="radio" name="allergy_test" value="0"
                                        {{ old('allergy_test', $assessment->allergy_test ? '1' : '0') == '0' ? 'checked' : '' }}>
                                    Tidak</label>
                                <label><input type="radio" name="allergy_test" value="1"
                                        {{ old('allergy_test', $assessment->allergy_test ? '1' : '0') == '1' ? 'checked' : '' }}>
                                    Ya</label>
                            </td>
                            <td class="label-cell"></td>
                            <td></td>
                            ...
                            <td>
                                <label class="mr-2"><input type="radio" name="pain_after" value="0"
                                        {{ old('pain_after', $assessment->pain_after ? '1' : '0') == '0' ? 'checked' : '' }}>
                                    Tidak</label>
                                <label><input type="radio" name="pain_after" value="1"
                                        {{ old('pain_after', $assessment->pain_after ? '1' : '0') == '1' ? 'checked' : '' }}>
                                    Ya</label>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center space-x-2">
                                    <label class="mr-2"><input type="radio" name="allergy_test_result"
                                            value="tidak_alergi"
                                            {{ old('allergy_test_result', $assessment->allergy_test_result) === 'tidak_alergi' ? 'checked' : '' }}>
                                        Tidak Alergi</label>
                                    <label><input type="radio" name="allergy_test_result" value="alergi"
                                            {{ old('allergy_test_result', $assessment->allergy_test_result) === 'alergi' ? 'checked' : '' }}>
                                        Alergi</label>
                                </div>
                            </td>
                            <td class="label-cell"></td>
                            ...
                            <td>
                                <label class="mr-2"><input type="radio" name="redness_after" value="0"
                                        {{ old('redness_after', $assessment->redness_after ? '1' : '0') == '0' ? 'checked' : '' }}>
                                    Tidak</label>
                                <label><input type="radio" name="redness_after" value="1"
                                        {{ old('redness_after', $assessment->redness_after ? '1' : '0') == '1' ? 'checked' : '' }}>
                                    Ya</label>
                            </td>
                        </tr>
            ...
            <div class="overflow-x-auto w-full mb-8">
                <div class="paper-container">
                    <div class="form-header">
                        {{-- <div style="font-weight: bold;">RS AWAL BROS<br><span
                                style="font-size: 9px; font-weight: normal;">Pekanbaru</span></div> --}}
                        <img src="{{ asset('login.png') }}" alt="" srcset="" class="mx-auto h-14 w-auto">
                        <div class="form-title">Catatan Pemberian Obat Kontras (Halaman 2 dari 2)</div>
                        <button type="button" onclick="addMedicationRow()"
                            class="no-print inline-flex items-center px-3 py-1.5 border border-slate-300 text-xs font-semibold rounded-lg text-slate-700 bg-white hover:bg-slate-50 transition cursor-pointer">
                            + Tambah Obat
                        </button>
                    </div>
                        ...
                        <tbody id="medicationTableBody">
                            ...
                            @empty
                                <tr>
                                    ...
                                    <td><input type="text" data-clocklet="format: HH:mm"
                                            name="medications[0][administered_at]" class="paper-input text-center"></td>
                    ...
                    @if (Auth::user()->role === 'perawat')
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center border-t border-slate-200 pt-6 mt-6">
                            <div>
                                ...
                                <div id="nurseSigDisplay" class="{{ $assessment->nurse_signature ? '' : 'hidden' }}">
                                    @if ($assessment->nurse_signature)
                                        <div class="bg-white p-3 border border-slate-200 rounded-lg inline-block shadow-sm mb-2">
                                            <img src="{{ $assessment->nurse_signature }}" alt="Tanda Tangan" class="h-16">
                                        </div>
                                    @endif
                                    <div>
                                        <button type="button" onclick="redrawNurse()" class="px-3 py-1 bg-amber-500 text-white text-xs font-semibold rounded hover:bg-amber-600 cursor-pointer">Tanda Tangan Ulang</button>
                                    </div>
                                </div>
                                <div id="nurseSigCanvasArea" class="{{ $assessment->nurse_signature ? 'hidden' : '' }}">
                            ...
                            <div class="text-xs text-slate-500 space-y-2">
                                ...
                                <p>Silakan gambar paraf / tanda tangan Anda pada bidang canvas di atas. Tanda tangan ini harus dibuat secara manual setiap kali Anda ingin menyimpan / memperbarui asesmen.</p>
                            </div>
                        </div>
                    @endif
                            ...
                            <div>
                                ...
                                @if (Auth::user()->signature)
                                    <div class="bg-white p-3 border border-slate-200 rounded-lg inline-block shadow-sm">
                                        ...
                                        <span class="text-[10px] text-green-600 font-bold block mt-1">Otomatis dari Profil Dokter</span>
                                    </div>
                                ...
                                @else
                                    <div class="p-3 bg-amber-50 border border-amber-200 text-amber-800 text-xs rounded-lg">
                                        Dokter belum memiliki tanda tangan di database. Silakan minta Superadmin/IT untuk mengunggah tanda tangan Anda di Master User agar dapat menandatangani dokumen secara otomatis.
                                    </div>
                                    <input type="hidden" name="doctor_signature" id="doctorSigInput" value="">
                                @endif
                            </div>
                            <div class="text-xs text-slate-500 space-y-2">
                                <p class="font-bold text-slate-800">Tanda Tangan Dokter Spesialis</p>
                                <p>Sistem otomatis memuat tanda tangan digital Anda yang diunggah oleh Superadmin/IT di Master User.</p>
                            </div>
                        </div>
                    @endif
                </div>
...
@section('scripts')
    <script>
        ...
        let medIndex =
            {{ old('medications', $assessment->radiologyContrastMedications) ? count(old('medications', $assessment->radiologyContrastMedications)) : 1 }};
        ...
        window.addEventListener('load', () => {
            loadDraft();
            @if(Auth::user()->role === 'perawat')
                // Only initialize if there is no pre-existing signature
                if (!document.getElementById('nurseSigCanvasArea').classList.contains('hidden')) {
        ...
        function redrawNurse() {
            document.getElementById('nurseSigDisplay').classList.add('hidden');
            document.getElementById('nurseSigCanvasArea').classList.remove('hidden');
            document.getElementById('nurseSigInput').value = '';
            setTimeout(initNurseSignaturePad, 100);
        }
        ...
        function submitMintaTtd(event) {
            ...
            const nurseSigInput = document.getElementById('nurseSigInput');

            if (canvasArea && !canvasArea.classList.contains('hidden')) {
                const canvas = document.getElementById('nurseSigPad');
                if (canvas) {
                    ...
                    nurseSigInput.value = canvas.toDataURL('image/png');
                } else {
                    alert('Tanda tangan perawat diperlukan.');
                    return;
                }
            } else {
                if (!nurseSigInput || !nurseSigInput.value) {
                    alert('Tanda tangan perawat diperlukan.');
                    return;
                }
            }
        ...
        @if (!empty($assessment->doctor_signature))
            document.addEventListener('DOMContentLoaded', () => {
                document.querySelectorAll(
                    '#assessmentForm input, #assessmentForm select, #assessmentForm textarea, #assessmentForm button, #assessmentForm canvas'
                ).forEach(el => {
                    el.disabled = true;
