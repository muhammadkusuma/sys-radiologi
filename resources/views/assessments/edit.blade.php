        ...
        <div class="overflow-x-auto w-full mb-8">
            ...
            <table class="paper-table">
                ...
                <tr>
                    ...
                    <td><textarea name="general_condition" rows="2" class="paper-input resize-y py-1" placeholder="Keadaan umum... (bisa enter/multiline)">{{ old('general_condition', $assessment->general_condition) }}</textarea></td>
                    <td class="label-cell">Keluhan</td>
                    <td><textarea name="during_complaint" rows="2" class="paper-input resize-y py-1" placeholder="Keluhan saat tindakan...">{{ old('during_complaint', $assessment->during_complaint) }}</textarea></td>
                    <td class="label-cell">Keluhan</td>
                    <td><textarea name="post_procedure_complaint" rows="2" class="paper-input resize-y py-1" placeholder="Keluhan setelah tindakan...">{{ old('post_procedure_complaint', $assessment->post_procedure_complaint) }}</textarea></td>
                </tr>

                <!-- Row 2 -->
                <tr>
                    <td class="label-cell">Tingkat Kesadaran</td>
                    <td><textarea name="consciousness_level" rows="2" class="paper-input resize-y py-1" placeholder="Tingkat kesadaran...">{{ old('consciousness_level', $assessment->consciousness_level) }}</textarea></td>
                    <td class="label-cell">Tanda-tanda Alergi</td>
                    <td><textarea name="allergy_sign_during" rows="2" class="paper-input resize-y py-1" placeholder="Tanda alergi saat tindakan...">{{ old('allergy_sign_during', $assessment->allergy_sign_during) }}</textarea></td>
                    <td class="label-cell">Tanda-tanda Alergi</td>
                    <td><textarea name="allergy_sign_after" rows="2" class="paper-input resize-y py-1" placeholder="Tanda alergi setelah tindakan...">{{ old('allergy_sign_after', $assessment->allergy_sign_after) }}</textarea></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><textarea name="extravasation_sign_during" rows="2" class="paper-input resize-y py-1" placeholder="cth: Tidak ada">{{ old('extravasation_sign_during', $assessment->extravasation_sign_during) }}</textarea></td>
                    <td class="label-cell"></td>
                    <td></td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="label-cell">Tanda-tanda Ekstravasasi</td>
                    <td><textarea name="extravasation_sign_after" rows="2" class="paper-input resize-y py-1" placeholder="cth: Tidak ada">{{ old('extravasation_sign_after', $assessment->extravasation_sign_after) }}</textarea></td>
                </tr>
