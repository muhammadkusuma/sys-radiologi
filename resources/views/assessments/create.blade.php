                ...
                <div class="paper-container">
                    ...
                    <table class="paper-table">
                            ...
                            <td>
                                <div class="flex items-center space-x-2">
                                    <input type="date" name="procedure_date"
                                        value="{{ old('procedure_date', date('Y-m-d')) }}" class="paper-input w-32">
                                    <span>Jam:</span>
                                    <input type="text" data-clocklet="format: HH:mm" name="procedure_time"
                                        value="{{ old('procedure_time', date('H:i')) }}"
                            ...
                            <td>
                                <select name="referring_doctor_id" class="paper-input">
                                    ...
                                    @foreach ($doctors as $doc)
                                        <option value="{{ $doc->id }}"
                                            {{ old('referring_doctor_id') == $doc->id ? 'selected' : '' }}>
                                            {{ $doc->name }}</option>
                                    @endforeach
                                </select>
                            </td>
                            ...
                            <td>
                                <select name="radiology_nurse_id" class="paper-input">
                                    ...
                                    @foreach ($nurses as $ns)
                                        <option value="{{ $ns->id }}"
                                            {{ old('radiology_nurse_id', Auth::id()) == $ns->id ? 'selected' : '' }}>
                                            {{ $ns->name }}</option>
                                    @endforeach
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="examination_type" value="{{ old('examination_type') }}"
