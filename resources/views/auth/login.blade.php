        ...
        <div class="bg-white py-8 px-4 shadow-xl border border-slate-200 sm:rounded-2xl sm:px-10">
            ...
            <form class="space-y-6" action="{{ route('login') }}" method="POST">
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input id="email" name="email" type="email" autocomplete="email" required value="{{ old('email') }}" class="appearance-none block w-full px-3 py-2 border border-slate-350 rounded-lg bg-white text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent sm:text-sm">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input id="password" name="password" type="password" autocomplete="current-password" required class="appearance-none block w-full px-3 py-2 border border-slate-350 rounded-lg bg-white text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent sm:text-sm">
                    </div>
                </div>
                ...
                <div>
                    <button type="submit" class="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-lg shadow-sm text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 cursor-pointer">
                        Masuk
                    </button>
                </div>
            </form>
            ...
            <div class="mt-8 border-t border-slate-200 pt-6">
                ...
                <div class="grid grid-cols-2 gap-3 text-xs">
                    <button type="button" onclick="fillCreds('perawat@example.com')" class="p-2.5 bg-slate-50 border border-slate-200 text-slate-700 rounded-lg text-left hover:bg-slate-100 transition cursor-pointer">
                    ...
                    <button type="button" onclick="fillCreds('dokter@example.com')" class="p-2.5 bg-slate-50 border border-slate-200 text-slate-700 rounded-lg text-left hover:bg-slate-100 transition cursor-pointer">
